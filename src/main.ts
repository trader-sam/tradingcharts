...
document.querySelector<HTMLDivElement>("#app")!.innerHTML = `
  ...
  <footer>OpenCharts <span>—</span> a deliberately small charting foundation.</footer></main>`;
