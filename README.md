...
- Main-price scale control: `getVisiblePriceRange()`, `setVisiblePriceRange({ from, to })`, and `resetPriceScale()` support fixed dashboard ranges while preserving automatic scaling by default.
